...
%     end
% %     if wass_cont
% %         epsilon_wass_list(i) = LS_epsilon_wass_value(data0_in{i,1});
% %     end
% end
% epsilon_cop_fix = mode(epsilon_cop_list)
% epsilon_sp_fix = mode(epsilon_sp_list)
% % epsilon_wass_fix = mode(epsilon_wass_list)
% 
% 
...
%     if Npoints <= 20
%         epsilon_cop = LS_epsilon_cop_value_general(data_cons,data_in{i,1})
%         epsilon_sp = LS_epsilon_sp_value_general(data_cons,data_in{i,1})
%     else
...
%     if Npoints <= 20
%         epsilon_wass = LS_epsilon_wass_value(data_in{i,1});
%     else
%         epsilon_wass = epsilon_wass_fix;
%     end    
...
%     % Wasserstein 
%     if wass_cont
%         [x_wass,obj_wass,runtime_wass] = LS_wass(data_in{i,1},epsilon_wass); 
%         if runtime_wass > 30*60
%             wass_cont = false;
%             T_wass(i) = NaN;
%             wass_list(i) = NaN;
%         else       
%             T_wass(i) = runtime_wass;
%             x_wass = double(x_wass);
%             wass_list(i) = obj_exp_LS(x_wass,data_out{i,1});
%         end       
%     else
%         T_wass(i) = NaN;
%         wass_list(i) = NaN;
...
%     gap_wass(i) = (wass_list(i) - dro_cop_list(i))/wass_list(i);
