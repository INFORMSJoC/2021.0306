function [avg_cvar_cop,avg_cvar_sp,avg_cvar_saa,cop10,cop90,sp10,sp90,saa10,saa90] = outperformance_general(epsilon,epsilon_p,Npoints,K)
...
for i = 1:trial   
    ...
    [x_cop,obj_cop] = Newsvendor_PLD_cop_general(data_cons,data_in{i,1},epsilon,epsilon_p,K);
    x_cop = double(x_cop);
    ...
    [x_sp,obj_sp] = Newsvendor_PLD_sp_general(data_cons,data_in{i,1},epsilon,epsilon_p,K);
    x_sp = double(x_sp);
